...
$pending_petitions = $petition_obj->get_all_pending();
$approved_petitions = $petition_obj->get_all_approved();
$rejected_petitions = $petition_obj->get_all_rejected();
?>
    ...
    <section data-tm-bg-color="#fff">
      <div class="section-content mt-lg--0 pt-lg--0" data-tm-margin-top="-183" data-tm-padding-top="184">
        <div class="container">
          ...
          <?php if ($pending_petitions && is_array($pending_petitions)) : ?>
            <div class="tm-sc-section-title section-title text-center mb-10 mt-50">
              <div class="row">
                <div class="col-lg-5 m-auto">
                  <div class="title-wrapper mb-0">

                    <h2 class="title">Pending Petitions</h2>
            ...
            <div class="row">
              <?php foreach ($pending_petitions as $petition) :
                      ...
                      <div class="entry-header">
                        <div class="post-thumb">
                          <div class="post-thumb-inner">
                            <div class="thumb">
                              <img class="w-100" src="<?php echo $petition['image']; ?>" alt="<?php echo $petition['title']; ?>" />
                            </div>
                            <div class="blog-meta">
                              <span class="admin-type mr-10"><i class="far fa-user-circle"></i><?php echo $user['fullname']; ?></span>
                            </div>
                            <div class="meta-date"><?php echo date("d-m-Y", strtotime($petition['created_at'])); ?></div>
                          </div>
                        </div>
                      </div>
                      <div class="entry-content">
                        <h6 class="entry-title mt-0"><a href="petition-details.php?id=<?php echo $petition['id']; ?>"><?php echo $petition['title']; ?></a></h6>
                        <div class="post-btn-readmore"><a href="petition-details.php?id=<?php echo $petition['id']; ?>" class="btn btn-plain-text-with-arrow">Read More</a></div>
                      </div>
                    </article>
                  </div>
                </div>
          ...
          <?php if ($approved_petitions && is_array($approved_petitions)) : ?>
            <div class="tm-sc-section-title section-title text-center mb-10 mt-50">
              <div class="row">
                <div class="col-lg-5 m-auto">
                  <div class="title-wrapper mb-0">

                    <h2 class="title">Approved Petitions</h2>
            ...
            <div class="row">
              <?php foreach ($approved_petitions as $petition) :
                $user = $user_obj->find_one($petition['user_id']);
              ?>
                <div class="col-md-6 col-lg-4">
                  <div class="blog-current-style1 mb-lg-30">
          ...
          <?php if ($rejected_petitions && is_array($rejected_petitions)) : ?>
            <div class="tm-sc-section-title section-title text-center mb-10 mt-50">
              <div class="row">
                <div class="col-lg-5 m-auto">
                  <div class="title-wrapper mb-0">

                    <h2 class="title">Rejected Petitions</h2>
            ...
            <div class="row">
              <?php foreach ($rejected_petitions as $petition) :
                $user = $user_obj->find_one($petition['user_id']);
              ?>
                <div class="col-md-6 col-lg-4">
                  <div class="blog-current-style1 mb-lg-30">
